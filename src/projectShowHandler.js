const chatSiteValues = {
  ...
  skillsLibrary: `<li class="bar"><div class="bar__metadata"><span class="skills__title">FrontEnd</span></div></li><li>전체 페이지 데이터 처리</li>`,
  skillsFrameWork: `<li class="bar"><div class="bar__metadata"><span class="skills__title">BackEnd</span></div></li><li>cookie-parser</li><li>sequelize</li><li>mongodb</li><li>multer</li>`,
  skillsHref:
...
const shopSiteValues = {
  ...
  skillsLibrary: `<li class="bar"><div class="bar__metadata"><span class="skills__title">FrontEnd</span></div></li><li>react-query</li><li>react-router-dom</li><li>recoil</li><li>Observer</li><li>유저 페이지 구현</li><li>게시글 쓰기 페이지 구현</li><li>전체적인 데이터 처리</li><li>React Warning 수정</li>`,
  skillsFrameWork: `<li class="bar"><div class="bar__metadata"><span class="skills__title">BackEnd</span></div></li><li>OAuth 코드 구현</li>`,
  skillsHref:
...
const openAiValues = {
  ...
  skillsLibrary: `<li class="bar"><div class="bar__metadata"><span class="skills__title">FrontEnd</span></div></li>`,
  skillsFrameWork: `<li class="bar"><div class="bar__metadata"><span class="skills__title">BackEnd</span></div></li><li>typeorm</li><li>mongoose</li><li>openAI Fine tuning</li><li>jsonwebtoken</li><li>session-file-store</li><li>crypto</li>`,
  skillsHref:
